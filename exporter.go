...
var proxysql_global_metrics = map[string]string{
	...
	"backend_query_time_nsec":      "Counter",
	...
	"com_autocommit":               "Counter",
	"com_autocommit_filtered":      "Counter",
	"com_backend_change_user":      "Counter",
	"com_backend_init_db":          "Counter",
	"com_backend_set_names":        "Counter",
	"com_backend_stmt_close":       "Counter",
	"com_backend_stmt_execute":     "Counter",
	"com_backend_stmt_prepare":     "Counter",
	"com_commit":                   "Counter",
	"com_commit_filtered":          "Counter",
	"com_frontend_init_db":         "Counter",
	"com_frontend_set_names":       "Counter",
	"com_frontend_stmt_close":      "Counter",
	"com_frontend_stmt_execute":    "Counter",
	"com_frontend_stmt_prepare":    "Counter",
	"com_frontend_use_db":          "Counter",
	"com_rollback":                 "Counter",
	"com_rollback_filtered":        "Counter",
	"connpool_get_conn_failure":    "Counter",
	"connpool_get_conn_immediate":  "Counter",
	"connpool_get_conn_success":    "Counter",
	"mysql_monitor_workers":        "Gauge",
	"mysql_thread_workers":         "Gauge",
